...
./halite --replay-directory replays/ -vvv --width 32 --height 32 "java -jar jars/V195.jar" "java -XX:+UnlockCommercialFeatures -XX:+FlightRecorder -jar target/uberjar/MyBot.jar -log"
mv flog* replays/
rm replays/*.log
