...
./halite --replay-directory replays/ -vvv --width 32 --height 32 "java -jar target/uberjar/MyBot.jar -log" "java -jar jars/V162.jar" "java -jar jars/V158.jar" "java -jar jars/V159.jar"
